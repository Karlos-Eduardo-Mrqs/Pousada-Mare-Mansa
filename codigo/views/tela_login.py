...
from controllers.control_usuario import ControlUsuario


class TelaLogin:
    def __init__(self, root, app, cliente_controller):
        self.root = root
        self.app = app
        self.logger = LoggerJSON()
        self.controller_usuario = cliente_controller  # Passado pelo main
